          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
             <!--  <div class="text-center text-muted mb-4">
                ...
                <form method="POST" action='<?php echo e(url("register/admin")); ?>' aria-label="<?php echo e(__('Register')); ?>">
...
<?php /**PATH /home/xzoomtech/portfolio.pxdollar.com/resources/views/admin/register.blade.php ENDPATH**/ ?>