...
<body class="bg-default">
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 "><small>Enter New MetaMask Wallet Address</small></div>
 ...
 <form method="POST" action="<?php echo e(route('reset.pass')); ?>">
                        <?php echo csrf_field(); ?>                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-user"></i></span>
                    </div>
 <input id="email" class="form-control <?php $__errorArgs = ['id'];
...
unset($__errorArgs, $__bag); ?>" name="id" value="<?php echo e(old('id')); ?>" required autocomplete="id" placeholder="Enter Your User Id" autofocus>                     <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
 ...
 <input id="email" class="form-control <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('first_name')); ?>" required autocomplete="address" placeholder="MetaMask Wallet Address" autofocus>                     <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Referral_System_with_metamask_Crypto\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>