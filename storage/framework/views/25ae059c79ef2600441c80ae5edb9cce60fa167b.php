...
unset($__errorArgs, $__bag); ?>" name="id" value="<?php echo e(old('id')); ?>" required autocomplete="id" placeholder="Enter Your User Token" autofocus>                     <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
</html><?php /**PATH /home/xzoomtech/portfolio.pxdollar.com/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>