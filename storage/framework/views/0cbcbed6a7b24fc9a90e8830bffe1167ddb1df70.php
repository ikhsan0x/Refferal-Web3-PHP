            ...
            <div class="card-header bg-transparent pb-5">
             ...
             <div class="card-body">
                        <div class="alert alert-success" role="alert">
                            <?php echo e(__('successfully done operation please Signin to continue.')); ?>

                        </div>

                     <div class="text-center">
                  <a href="<?php echo e(asset('login')); ?>" class="btn btn-primary my-4">Signin</a>
                </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\Referral_System_with_metamask_Crypto\resources\views/auth/verify.blade.php ENDPATH**/ ?>