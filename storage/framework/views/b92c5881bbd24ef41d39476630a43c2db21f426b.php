        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 "></div>
             <div class="card-body">
                        <div class="alert alert-danger" role="alert">
                            <?php echo e(__('Please Select Address Which Use For Register Otherwise Changed Your Forgot Your Password With Your User Token.')); ?>

                        </div>

                     <div class="text-center">
                  <a href="<?php echo e(asset('home')); ?>" class="btn btn-primary my-4">back</a>
                </div>
                </div>
            </div>
...
</html><?php /**PATH /home/xzoomtech/portfolio.pxdollar.com/resources/views/fall.blade.php ENDPATH**/ ?>