...
<body class="bg-default">
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 "><small>Sign in with Your MetaMask Wallet Address</small></div>
 ...
 <input id="email" max="42" min="42" class="form-control <?php $__errorArgs = ['address'];
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('address')); ?>" required autocomplete="address" placeholder="MetaMask Wallet Address" autofocus>                     <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
</html><?php /**PATH /home/xzoomtech/portfolio.pxdollar.com/resources/views/auth/login.blade.php ENDPATH**/ ?>