                  ...
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-wallet"></i></span>
                                ...
                                <input id="name" type="text"  max="42" min="42" class="form-control <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('first_name')); ?>" placeholder="MetaMask Wallet Address"  autocomplete="address" required autofocus>
...
</html><?php /**PATH /home/xzoomtech/portfolio.pxdollar.com/resources/views/auth/register.blade.php ENDPATH**/ ?>